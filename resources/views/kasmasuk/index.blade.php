...
<div class="row">
  <div class="col-lg-2">
    <a href="<?php echo e(route('kasmasuk.create')); ?>" class="btn btn-primary btn-rounded btn-fw"><i
        class="fa fa-plus"></i>
      Tambah Kas Masuk</a>
  </div>
  <div class="col-lg-12">
...
<div class="row" style="margin-top: 20px;">
  <div class="col-lg-12">
    <form method="GET" action="<?php echo e(route('kasmasuk.index')); ?>">
      <div class="row">
        <div class="col-md-3">
...
foreach ($__currentLoopData as $data):
  ...
  $loop = $__env->getLastLoop(); ?>
              <tr>
                <td class="py-1"><?php  echo e($data->tgl); ?></td>
                <td>
                  <?php  echo e($data->kategori === "pembayaran" ? "Pembayaran" : ($data->kategori === "sumbangan" ? "Sumbangan" : ($data->kategori === "lain" ? "Lainnya" : "-"))); ?>
                ...
                <td>
                  <div class="btn-group dropdown">
                    ...
                    <div class="dropdown-menu" x-placement="bottom-start">
                      <a class="dropdown-item" href="<?php  echo e(route('kasmasuk.edit', $data->id)); ?>"> Edit </a>
                      <form action="<?php  echo e(route('kasmasuk.destroy', $data->id)); ?>" class="pull-left"
                        method="post">
