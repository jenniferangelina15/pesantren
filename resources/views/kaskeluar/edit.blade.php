...
<form action="<?php echo e(route('kaskeluar.update', $data->id)); ?>" method="post" enctype="multipart/form-data">
                      ...
                      <h4 class="card-title">Edit Kas Keluar</h4>
                        ...
                        <div class="form-group<?php echo e($errors->has('kategori') ? ' has-error' : ''); ?>">
                            ...
                            <select class="form-control" name="kategori" required="">
                                <option value="operasional" <?php echo e($data->kategori === "operasional" ? "selected" : ""); ?>>Operasional</option>
                                <option value="makanan" <?php echo e($data->kategori === "makanan" ? "selected" : ""); ?>>Makanan</option>
