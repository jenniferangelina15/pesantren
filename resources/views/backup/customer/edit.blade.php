...
<form action="<?php echo e(route('customer.update', $data->id)); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      <h4 class="card-title">Edit Customer</h4>
                        ...
                        <div class="form-group<?php echo e($errors->has('nik') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="nik" type="text" class="form-control" name="nik" value="<?php echo e($data->nik); ?>" maxlength="20" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('alamat') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="alamat" type="text" class="form-control" name="alamat" value="<?php echo e($data->alamat); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('no_hp') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="no_hp" type="text" class="form-control" name="no_hp" value="<?php echo e($data->no_hp); ?>" required>
