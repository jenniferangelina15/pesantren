    ...
    <li class="nav-item <?php echo e(setActive(['customer*', 'kostum*'])); ?>">
      ...
      <div class="collapse <?php echo e(setShow(['customer*', 'kostum*'])); ?>" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link <?php echo e(setActive(['customer*'])); ?>"
              href="<?php echo e(route('customer.index')); ?>">Data Customer</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo e(setActive(['kostum*'])); ?>"
              href="<?php echo e(route('kostum.index')); ?>">Data Kostum</a>
          </li>
        </ul>
      </div>
    </li>
