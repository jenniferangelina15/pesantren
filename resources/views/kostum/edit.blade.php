...
<form action="<?php echo e(route('kostum.update', $data->id)); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Edit Kostum <b><?php echo e($data->kostum); ?></b> </h4>
                      <form class="forms-sample">
                        <div class="form-group<?php echo e($errors->has('kostum') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="kostum" type="text" class="form-control" name="kostum" value="<?php echo e($data->kostum); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('harga') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="harga" type="text" class="form-control" name="harga" value="<?php echo e($data->harga); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('jumlah_kostum') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_kostum" type="number" maxlength="4" class="form-control" name="jumlah_kostum" value="<?php echo e($data->jumlah_kostum); ?>" required>
